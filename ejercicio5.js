...
const transFiltr = transacciones.filter(transaccion => transaccion.tipo === 'retiro' && transaccion.monto > 5000);
...
const totalMulta = transConMulta.reduce((total, transaccion) => total + transaccion.multa, 0);
